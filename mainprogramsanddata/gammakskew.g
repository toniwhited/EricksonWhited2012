...
format /rd 8,3;
if dofe == 0;
output file = gam_Kskew.out reset;
else;
output file = gam_K_withinskew.out reset;
endif;
outwidth 256;

shrinkgam = 0.025;
do while shrinkgam<=840;
...
Eki      = meanc(allc[idx+yy-1,1]);
Vchi      = (meanc(allc[idx+yy-1,1]^2) - Eki^2)@*ncount/(ncount - 1)@;
SDki      =  sqrt(Vchi);
thirdchi  =  meanc((allc[idx+yy-1,1] - Eki)^3);
skewchi   =  thirdchi/(SDki^3);
fourtheta =  meanc((allc[idx+yy-1,1] - Eki)^4);
kurtchi   =  (fourtheta/(SDki^4));
fiftheta  =  meanc((allc[idx+yy-1,1] - Eki)^5);
std5chi   =  (fiftheta)/(SDki^5);
sixtheta  =  meanc((allc[idx+yy-1,1] - Eki)^6);
std6chi   =  (sixtheta)/(SDki^6);
sevenchi  = meanc((allc[idx+yy-1,1] - Eki)^7);
...
aveEy2x = aveEy2x + meanc((allydot[idx+yy-1,1]^2).*allxdot[idx+yy-1,1]);
aveEyx2 = aveEyx2 + meanc((allxdot[idx+yy-1,1]^2).*allydot[idx+yy-1,1]);

endfor;



    /* This part does the serial correlation calculations for the summary stats. */
       ytee = selif(ally,yr./=1); ytee1 = selif(ally,yr./=keepnyr);
       xtee = selif(allc,yr./=1); xtee1 = selif(allc,yr./=keepnyr);
       ztee = selif(allz,yr./=1); ztee1 = selif(allz,yr./=keepnyr);
       icepttee = ones(rows(ztee),1);
...
skewchi = avskewchi/(keepnyr*nrun);


"------------------------------CMD in Percent----------------------------------";


"beta   skewchi = ";; skewchi;; "&"  sumb/nrun/beta-1;;               "&"  sumbiv/nrun/beta-1;;               "&"  sumbab/nrun/beta-1;;                  for qq (1, nestim, 1); "&" sumg[1,qq]/nrun/beta-1;;          endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&"  median(bkeep[1:nrun,.])/beta-1;; "&"  median(bivkeep[1:nrun,.])/beta-1;; "&"  median(babkeep[1:nrun,.])/beta-1;;    for qq (1, nestim, 1); "&" median(gkeep[1:nrun,qq])/beta-1;; endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&"  sumerrb/nrun;;                   "&"  sumerrbiv/nrun;;                   "&"  sumerrbab/nrun;;                      for qq (1, nestim, 1); "&" sumerrg[1,qq]/nrun;;              endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&"  pcountb[1,1]/nrun;;              "&"  pcountbiv[1,1]/nrun;;              "&"  pcountbab[1,1]/nrun;;                 for qq (1, nestim, 1); "&" pcountg[1,qq]/nrun;;              endfor; "\\" "\\";; " [11pt] ";


for ee(1, nz, 1);
"alpha  skewchi = ";; skewchi;; "&" sumz[ee,1]/nrun/delta[ee,1]-1;;          "&" sumziv/nrun/delta[ee,1]-1;;                "&" sumzab/nrun/delta[ee,1]-1;;               for qq (1, nestim, 1); "&" sumd[ee,qq]/nrun/delta[ee,1]-1;;                       endfor; "\\" "\\";; " [2pt] ";
"median skewchi = ";; skewchi;; "&" median(zkeep[1:nrun,ee])/delta[ee,1]-1;; "&" median(zivkeep[1:nrun,.])/delta[ee,1]-1;;  "&" median(zabkeep[1:nrun,.])/delta[ee,1]-1;; for qq (1, nestim, 1); "&" median(dkeep[1:nrun,(ee-1)*nestim+qq])/delta[ee,1]-1;; endfor; "\\" "\\";; " [2pt] ";
"mad    skewchi = ";; skewchi;; "&" sumerrz[ee,1]/nrun;;                     "&" sumerrziv/nrun;;                           "&" sumerrzab/nrun;;                          for qq (1, nestim, 1); "&" sumerrd[ee,qq]/nrun;;                                  endfor; "\\" "\\";; " [2pt] ";
"pcnt   skewchi = ";; skewchi;; "&" pcountz[ee,1]/nrun;;                     "&" pcountziv[1,1]/nrun;;                      "&" pcountzab[1,1]/nrun;;                     for qq (1, nestim, 1); "&" pcountd[ee,qq]/nrun;;                                  endfor; "\\" "\\";; " [11pt] ";
endfor;

"rho2   skewchi = ";; skewchi;; "&" sumARR/nrun/rho2-1;;              "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sump[1,qq]/nrun/rho2-1;;          endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&"  median(rkeep[1:nrun,.])/rho2-1;; "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" median(pkeep[1:nrun,qq])/rho2-1;; endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&" sumerrr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sumerrp[1,qq]/nrun;;              endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&" pcountr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" pcountp[1,qq]/nrun;;              endfor; "\\" "\\";; " [11pt] ";

"tau2   skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumt[1,qq]/nrun/tau2-1;;          endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" median(tkeep[1:nrun,qq])/tau2-1;; endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumerrt[1,qq]/nrun;;              endfor; "\\" "\\";; " [2pt] ";
"       skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" pcountt[1,qq]/nrun;;              endfor; "\\" "\\";; " [11pt] ";

"------------------------------CMD----------------------------------------------";

"beta  skewchi = ";; skewchi;; "&"  sumb/nrun;;               "&"  sumbiv/nrun;;               "&"  sumbab/nrun;;                  for qq (1, nestim, 1); "&" sumg[1,qq]/nrun;;          endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&"  median(bkeep[1:nrun,.]);; "&"  median(bivkeep[1:nrun,.]);; "&"  median(babkeep[1:nrun,.]);;    for qq (1, nestim, 1); "&" median(gkeep[1:nrun,qq]);; endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&"  sumerrb/nrun;;            "&"  sumerrbiv/nrun;;            "&"  sumerrbab/nrun;;               for qq (1, nestim, 1); "&" sumerrg[1,qq]/nrun;;       endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&"  pcountb[1,1]/nrun;;       "&"  pcountbiv[1,1]/nrun;;       "&"  pcountbab[1,1]/nrun;;          for qq (1, nestim, 1); "&" pcountg[1,qq]/nrun;;       endfor; "\\" "\\";; " [11pt] ";


for ee(1, nz, 1);
"alpha skewchi = ";; skewchi;; "&" sumz[ee,1]/nrun;;          "&" sumziv/nrun;;                "&" sumzab/nrun;;               for qq (1, nestim, 1); "&" sumd[ee,qq]/nrun;;                       endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" median(zkeep[1:nrun,ee]);; "&" median(zivkeep[1:nrun,.]);;  "&" median(zabkeep[1:nrun,.]);; for qq (1, nestim, 1); "&" median(dkeep[1:nrun,(ee-1)*nestim+qq]);; endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" sumerrz[ee,1]/nrun;;       "&" sumerrziv/nrun;;             "&" sumerrzab/nrun;;            for qq (1, nestim, 1); "&" sumerrd[ee,qq]/nrun;;                    endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" pcountz[ee,1]/nrun;;       "&" pcountziv[1,1]/nrun;;        "&" pcountzab[1,1]/nrun;;       for qq (1, nestim, 1); "&" pcountd[ee,qq]/nrun;;                    endfor; "\\" "\\";; " [11pt] ";
endfor;

"rho2  skewchi = ";; skewchi;; "&" sumARR/nrun;;                     "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sump[1,qq]/nrun;;          endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&"  median(rkeep[1:nrun,.]);;        "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" median(pkeep[1:nrun,qq]);; endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" sumerrr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sumerrp[1,qq]/nrun;;       endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" pcountr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" pcountp[1,qq]/nrun;;       endfor; "\\" "\\";; " [11pt] ";

"tau2  skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumt[1,qq]/nrun;;          endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" median(tkeep[1:nrun,qq]);; endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumerrt[1,qq]/nrun;;       endfor; "\\" "\\";; " [2pt] ";
"      skewchi = ";; skewchi;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" pcountt[1,qq]/nrun;;       endfor; "\\" "\\";; " [11pt] ";
