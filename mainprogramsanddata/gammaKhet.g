...
format /rd 8,3;
if dofe == 0;
output file = gam_Khet.out reset;
else;
output file = gam_Khet_within.out reset;
endif;
outwidth 256;
...
bttdb:
   ...
   if keepnyr>1 or nyr > 1;
    ...
    if deghet == 0;  u = Sdu*uk;
    else;            u = (uk.*(1+mess*deghet*10))/sqrt(1+(deghet*10)^2);  u = Sdu*u;
    endif;
    epsilon  = ek*Sde;
...
print;
"Beta";
"     OLS:   ";; (sumerrb/nrun);;  ((sumb-beta)/nrun);
print;
"     GMM:   ";; (sumerrg/nrun);;  ((sumg-beta)/nrun);
print;
"Alpha_1";
"     OLS:   ";; (sumerrz/nrun);;  ((sumz-delta)/nrun);
print;
"     GMM:   ";; (sumerrd/nrun);;  ((sumd-delta)/nrun);
print;
print;
...
print;
"deghet = ";; deghet;; "J-test";; EWjcount/nrun;
print;
...
"beta   deghet = ";; deghet;; "&"  sumb/nrun/beta-1;;               "&"  sumbiv/nrun/beta-1;;               "&"  sumbab/nrun/beta-1;;                  for qq (1, nestim, 1); "&" sumg[1,qq]/nrun/beta-1;;          endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&"  median(bkeep[1:nrun,.])/beta-1;; "&"  median(bivkeep[1:nrun,.])/beta-1;; "&"  median(babkeep[1:nrun,.])/beta-1;;    for qq (1, nestim, 1); "&" median(gkeep[1:nrun,qq])/beta-1;; endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&"  sumerrb/nrun;;                   "&"  sumerrbiv/nrun;;                   "&"  sumerrbab/nrun;;                      for qq (1, nestim, 1); "&" sumerrg[1,qq]/nrun;;              endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&"  pcountb[1,1]/nrun;;              "&"  pcountbiv[1,1]/nrun;;              "&"  pcountbab[1,1]/nrun;;                 for qq (1, nestim, 1); "&" pcountg[1,qq]/nrun;;              endfor; "\\" "\\";; " [11pt] ";


for ee(1, nz, 1);
"alpha  deghet = ";; deghet;; "&" sumz[ee,1]/nrun/delta[ee,1]-1;;          "&" sumziv/nrun/delta[ee,1]-1;;                "&" sumzab/nrun/delta[ee,1]-1;;               for qq (1, nestim, 1); "&" sumd[ee,qq]/nrun/delta[ee,1]-1;;                       endfor; "\\" "\\";; " [2pt] ";
"median deghet = ";; deghet;; "&" median(zkeep[1:nrun,ee])/delta[ee,1]-1;; "&" median(zivkeep[1:nrun,.])/delta[ee,1]-1;;  "&" median(zabkeep[1:nrun,.])/delta[ee,1]-1;; for qq (1, nestim, 1); "&" median(dkeep[1:nrun,(ee-1)*nestim+qq])/delta[ee,1]-1;; endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" sumerrz[ee,1]/nrun;;                     "&" sumerrziv/nrun;;                           "&" sumerrzab/nrun;;                          for qq (1, nestim, 1); "&" sumerrd[ee,qq]/nrun;;                                  endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" pcountz[ee,1]/nrun;;                     "&" pcountziv[1,1]/nrun;;                      "&" pcountzab[1,1]/nrun;;                     for qq (1, nestim, 1); "&" pcountd[ee,qq]/nrun;;                                  endfor; "\\" "\\";; " [11pt] ";
endfor;

"rho2   deghet = ";; deghet;; "&" sumARR/nrun/rho2-1;;              "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sump[1,qq]/nrun/rho2-1;;          endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&"  median(rkeep[1:nrun,.])/rho2-1;; "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" median(pkeep[1:nrun,qq])/rho2-1;; endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" sumerrr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sumerrp[1,qq]/nrun;;              endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" pcountr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" pcountp[1,qq]/nrun;;              endfor; "\\" "\\";; " [11pt] ";

"tau2   deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumt[1,qq]/nrun/tau2-1;;          endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" median(tkeep[1:nrun,qq])/tau2-1;; endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumerrt[1,qq]/nrun;;              endfor; "\\" "\\";; " [2pt] ";
"       deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" pcountt[1,qq]/nrun;;              endfor; "\\" "\\";; " [11pt] ";

"------------------------------CMD----------------------------------------------";

"beta  deghet = ";; deghet;; "&"  sumb/nrun;;               "&"  sumbiv/nrun;;               "&"  sumbab/nrun;;                  for qq (1, nestim, 1); "&" sumg[1,qq]/nrun;;          endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&"  median(bkeep[1:nrun,.]);; "&"  median(bivkeep[1:nrun,.]);; "&"  median(babkeep[1:nrun,.]);;    for qq (1, nestim, 1); "&" median(gkeep[1:nrun,qq]);; endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&"  sumerrb/nrun;;            "&"  sumerrbiv/nrun;;            "&"  sumerrbab/nrun;;               for qq (1, nestim, 1); "&" sumerrg[1,qq]/nrun;;       endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&"  pcountb[1,1]/nrun;;       "&"  pcountbiv[1,1]/nrun;;       "&"  pcountbab[1,1]/nrun;;          for qq (1, nestim, 1); "&" pcountg[1,qq]/nrun;;       endfor; "\\" "\\";; " [11pt] ";


for ee(1, nz, 1);
"alpha deghet = ";; deghet;; "&" sumz[ee,1]/nrun;;          "&" sumziv/nrun;;                "&" sumzab/nrun;;               for qq (1, nestim, 1); "&" sumd[ee,qq]/nrun;;                       endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" median(zkeep[1:nrun,ee]);; "&" median(zivkeep[1:nrun,.]);;  "&" median(zabkeep[1:nrun,.]);; for qq (1, nestim, 1); "&" median(dkeep[1:nrun,(ee-1)*nestim+qq]);; endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" sumerrz[ee,1]/nrun;;       "&" sumerrziv/nrun;;             "&" sumerrzab/nrun;;            for qq (1, nestim, 1); "&" sumerrd[ee,qq]/nrun;;                    endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" pcountz[ee,1]/nrun;;       "&" pcountziv[1,1]/nrun;;        "&" pcountzab[1,1]/nrun;;       for qq (1, nestim, 1); "&" pcountd[ee,qq]/nrun;;                    endfor; "\\" "\\";; " [11pt] ";
endfor;

"rho2  deghet = ";; deghet;; "&" sumARR/nrun;;                     "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sump[1,qq]/nrun;;          endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&"  median(rkeep[1:nrun,.]);;        "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" median(pkeep[1:nrun,qq]);; endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" sumerrr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" sumerrp[1,qq]/nrun;;       endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" pcountr/nrun;;                    "&" "  -----  ";;     "&" "  -----  ";;     for qq (1, nestim, 1); "&" pcountp[1,qq]/nrun;;       endfor; "\\" "\\";; " [11pt] ";

"tau2  deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumt[1,qq]/nrun;;          endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" median(tkeep[1:nrun,qq]);; endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" sumerrt[1,qq]/nrun;;       endfor; "\\" "\\";; " [2pt] ";
"      deghet = ";; deghet;; "&" "  -----  ";;      "&" "  -----  ";;     "&" "  -----  ";;         for qq (1, nestim, 1); "&" pcountt[1,qq]/nrun;;       endfor; "\\" "\\";; " [11pt] ";
...
"IV beta  deghet = ";; deghet;; "&"  sumbiv/nrun;;               "&"  sumbab/nrun;
"         deghet = ";; deghet;; "&"  median(bivkeep[1:nrun,.]);; "&"  median(babkeep[1:nrun,.]);
"         deghet = ";; deghet;; "&"  sumerrbiv/nrun;;            "&"  sumerrbab/nrun;
"         deghet = ";; deghet;; "&"  pcountbiv[1,1]/nrun;;       "&"  pcountbab[1,1]/nrun;

for ee(1, nz, 1);
"IV alpha deghet = ";; deghet;; "&" sumziv/nrun;;                "&" sumzab/nrun;
"         deghet = ";; deghet;; "&" median(zivkeep[1:nrun,.]);;  "&" median(zabkeep[1:nrun,.]);
"         deghet = ";; deghet;; "&" sumerrziv/nrun;;             "&" sumerrzab/nrun;
"         deghet = ";; deghet;; "&" pcountziv[1,1]/nrun;;        "&" pcountzab[1,1]/nrun;
endfor;
